...
namespace Esmart.Application.WebApi.Handler
{
	public class LanguageHandler : DelegatingHandler
	{
		...
		private readonly List<string> _supportedLanguages = new List<string> { LangenGB,  LangfrFR  };
		...
		protected override async Task<HttpResponseMessage> SendAsync(HttpRequestMessage request, CancellationToken cancellationToken)
		{
			...
			{
				// No localization found. look for Globalisation
